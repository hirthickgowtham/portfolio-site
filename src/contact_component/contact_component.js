        ...
        <div id = "contact"className={styles.covers}>
                <div className={styles.resume_continer}>
                        ...
                        className={styles.resume_button}>
                          <a href="https://drive.google.com/file/d/1acd-iWKk-J0_dmxomSJq1wrlI1wkElBx/view?usp=sharing" target="_blank">  <li className={styles.button}  ref={resume_arrow}>Resume <i class={arrowChange?up_arrow:down_arrow} ></i></li></a>
                        </motion.div>
                        <motion.div
                ...
                <div className={styles.copy_right}>
                   <a href="mailto:gowthamhirthick@gmail.com" target="_blank"> <motion.li
                    ...
                    transition={{
                     ...
                     className={styles.copy}>© {new Date().getFullYear()} | Hirthick Gowtham G</motion.p>
                </div>
        </div>
